 ...
 * @author simon & ennio
 **/
public class LessThanOrEqualExpression implements IExpression
{
    private final String left;
    private final String right;

    public LessThanOrEqualExpression(String left, String right)
    {
        this.left = left;
        this.right = right;

        if (!isLiteral(left) || !isLiteral(right)) {
            throw new RuntimeException("LessThanOrEqualExpression only supports literals");
        }
    }
