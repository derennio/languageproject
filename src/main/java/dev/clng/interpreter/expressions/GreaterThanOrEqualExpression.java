 ...
 * @author simon & ennio
 **/
public class GreaterThanOrEqualExpression implements IExpression
{
    private final String left;
    private final String right;

    public GreaterThanOrEqualExpression(String left, String right)
    {
        this.left = left;
        this.right = right;

        if (!isLiteral(left) || !isLiteral(right)) {
            throw new RuntimeException("GreaterThanOrEqualExpression only supports literals");
        }
    }
